...
{
    public class BladeShaft : FragmentPart, IBottomDimensionProvider
    {
        public BladeShaft(Func<Vector3D> origin) : base(origin) { }
        ...
        {
            return ElementFromModel(winfx, uzi, RenderModel() as GeometryModel3D, @"Blade", null);
        }
