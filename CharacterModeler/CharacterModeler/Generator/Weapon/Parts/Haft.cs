...
{
    public class Haft : CylindricalPart, IBottomRadiusProvider, ITopRadiusProvider
    {
        public Haft(Func<Vector3D> origin, int meshKey)
            : base(origin, meshKey)
        {
        }

        #region IBottomDimensionProvider & ITopDimensionProvider Members
        ...
        protected override string MaterialKey { get { return @"Haft"; } }
