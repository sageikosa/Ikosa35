...
{
    public class Pole : CylindricalPart, IBottomRadiusProvider, ITopRadiusProvider
    {
        public Pole(Func<Vector3D> origin, int meshKey) : base(origin, meshKey) { }
        ...
        #region IBottomDimensionProvider Members
        public double Thickness { get { return Radius * 2; } }
        public double Width { get { return Radius * 2; } }
        #endregion

        protected override string MaterialKey { get { return @"Pole"; } }
