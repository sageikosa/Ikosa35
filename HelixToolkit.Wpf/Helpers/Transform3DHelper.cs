...
namespace HelixToolkit.Wpf
{
    ...
    public static class Transform3DHelper
    {
        ...
        /// <summary>Converts a Transform3D into a MatrixTransform3D, especially useful for Transform3DGroup reduction</summary>
        public static Transform3D ToMatrixTransform(this Transform3D self)
        {
            return new MatrixTransform3D(self.Value);
        }
    }
}