// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BindableRotateManipulator.cs" company="Helix 3D Toolkit">
...
namespace HelixToolkit.Wpf
{
    ...
    public class BindableRotateManipulator : Manipulator
    {
        ...
        protected override void OnValueChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            this.Transform = Transform3DHelper.CombineTransform(rotateTransform, this.Transform).ToMatrixTransform();

            if (this.TargetTransform != null)
            {
                var targetRotateTransform = new RotateTransform3D(new AxisAngleRotation3D(this.Axis, theta), this.Pivot);
                this.TargetTransform = Transform3DHelper.CombineTransform(targetRotateTransform, this.TargetTransform).ToMatrixTransform();
            }
        }
    }
}