...
namespace HelixToolkit.Wpf
{
    ...
    {
        /// <summary>can rotate x property.</summary>
        ...
        /// <summary>can rotate y property.</summary>
        ...
        /// <summary>can rotate z property.</summary>
        ...
        /// <summary>can translate x property.</summary>
        ...
        /// <summary>can translate y property.</summary>
        ...
        /// <summary>can translate z property.</summary>
        ...
        public CombinedManipulator()
        {
            ...
            BindingOperations.SetBinding(this.translateXManipulator, Manipulator.TargetTransformProperty, new Binding("TargetTransform") { Source = this });
            BindingOperations.SetBinding(this.translateYManipulator, Manipulator.TargetTransformProperty, new Binding("TargetTransform") { Source = this });
            BindingOperations.SetBinding(this.translateZManipulator, Manipulator.TargetTransformProperty, new Binding("TargetTransform") { Source = this });
            BindingOperations.SetBinding(this.rotateXManipulator, RotateManipulator.DiameterProperty, new Binding("Diameter") { Source = this });
            BindingOperations.SetBinding(this.rotateYManipulator, RotateManipulator.DiameterProperty, new Binding("Diameter") { Source = this });
            BindingOperations.SetBinding(this.rotateZManipulator, RotateManipulator.DiameterProperty, new Binding("Diameter") { Source = this });
            BindingOperations.SetBinding(this.rotateXManipulator, Manipulator.TargetTransformProperty, new Binding("TargetTransform") { Source = this });
            BindingOperations.SetBinding(this.rotateYManipulator, Manipulator.TargetTransformProperty, new Binding("TargetTransform") { Source = this });
            BindingOperations.SetBinding(this.rotateZManipulator, Manipulator.TargetTransformProperty, new Binding("TargetTransform") { Source = this });

            this.OnChildrenChanged();
        }

        /// <summary>Gets or sets a value indicating whether this instance can rotate X.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether this instance can rotate Y.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether this instance can rotate Z.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether this instance can translate X.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether this instance can translate Y.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether this instance can translate Z.</summary>
        ...
        /// <summary>Gets or sets the offset of the visual (this vector is added to the Position point).</summary>
        ...
        /// <summary>Gets or sets the pivot point of the manipulator.</summary>
        ...
        /// <summary>Gets or sets the position of the manipulator.</summary>
        /// <value> The position. </value>
        ...
        /// <summary>Gets or sets the target transform.</summary>
