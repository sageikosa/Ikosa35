...
namespace HelixToolkit.Wpf
{
    ...
    /// <summary>An abstract base class for manipulators.</summary>
    public abstract class Manipulator : UIElement3D
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Manipulator" /> class.</summary>
        ...
        /// <summary>Gets or sets the color of the manipulator.</summary>
        ...
        {
            get { return (Vector3D)this.GetValue(OffsetProperty); }
        ...
        /// <summary>Gets or sets TargetTransform.</summary>
        ...
        /// <summary>Gets or sets the manipulator value.</summary>
        ...
        /// <summary>Gets or sets the hit plane normal.</summary>
        protected Vector3D HitPlaneNormal { get; set; }

        /// <summary>Gets or sets the model.</summary>
        protected GeometryModel3D Model { get; set; }

        /// <summary>Gets or sets the parent viewport.</summary>
        protected Viewport3D ParentViewport { get; set; }

        /// <summary>Binds this manipulator to a given Visual3D.</summary>
        ...
        /// <summary>Releases the binding of this manipulator.</summary>
        ...
        /// <summary>Called when Geometry is changed.</summary>
        ...
        /// <summary>Projects the point on the hit plane.</summary>
        /// <param name="p">The point.</param>
        /// <param name="hitPlaneOrigin">The hit Plane Origin. </param>
        ...
        /// <summary>Called when the geometry changed.</summary>
        ...
        /// <summary>Transforms from world to local coordinates.</summary>
        /// <param name="worldPoint">The point (world coordinates). </param>
        /// <returns>Transformed vector (local coordinates). </returns>
        ...
        /// <summary>Transforms from local to world coordinates.</summary>
        /// <param name="point">The point (local coordinates). </param>
        /// <returns>Transformed point (world coordinates). </returns>
        ...
        /// <summary>Transforms from local to world coordinates.</summary>
        /// <param name="vector">The vector (local coordinates). </param>
        /// <returns>Transformed vector (world coordinates). </returns>
        ...
        /// <summary>The color changed.</summary>
        /// <param name="d">The sender. </param>
        /// <param name="e">The event arguments. </param>
        ...
        /// <summary>Called when position has been changed.</summary>
        /// <param name="d">The sender. </param>
        /// <param name="e">The <see cref="System.Windows.DependencyPropertyChangedEventArgs"/> instance containing the event data. </param>
        ...
        /// <summary>Called when value has been changed.</summary>
        /// <param name="d">The sender. </param>
        /// <param name="e">The <see cref="System.Windows.DependencyPropertyChangedEventArgs"/> instance containing the event data. </param>
