...
namespace HelixToolkit.Wpf
{
    ...
    public class TranslateManipulator : Manipulator
    {
        ...
        /// <summary>Gets or sets the diameter of the manipulator arrow.</summary>
        ...
        /// <summary>Gets or sets the direction of the translation.</summary>
        ...
        /// <summary>Gets or sets the length of the manipulator arrow.</summary>
        ...
        /// <summary>Called when geometry has been changed.</summary>
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (this.IsMouseCaptured)
            {
                ...
                if (this.TargetTransform != null)
                {
                    ...
                    this.TargetTransform = Transform3DHelper.CombineTransform(translateTransform, this.TargetTransform).ToMatrixTransform();
                }
                else
                {
                    this.Position += delta;
