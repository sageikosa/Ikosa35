...
{
    [Serializable]
    public class FeedSpellItem : FeedItem, IPowerUse<SpellSource>
    {
        public FeedSpellItem(IFeedableItem item, SpellSource spellSource, ISpellMode spellMode, string orderKey)
            : base(item, orderKey)
        {
