...
{
    [Serializable]
    public class ConstructClass<CritterType> : MonsterClass<CritterType>
        where CritterType : Species
    {
        #region Construction
        public ConstructClass(Type[] skills, int maxLevel, 
            decimal optionalFraction, decimal smallestFraction, bool flexibleAspect)
            : base(10, maxLevel, optionalFraction, smallestFraction, flexibleAspect)
        {
            _ClassSkills = skills;
        ...
        public ConstructClass(Type[] skills, int maxLevel, 
            ...
            decimal optionalFraction, decimal smallestFraction, bool flexibleAspect)
            : base(10, maxLevel, sizeRanges, optionalFraction, smallestFraction, flexibleAspect)
        {
            _ClassSkills = skills;
            _HasGoodFortitude = false;
            _HasGoodReflex = false;
        ...
        public override string ClassName { get { return @"Construct"; } }
        ...
        // TODO: extra health points by size
    }
}
