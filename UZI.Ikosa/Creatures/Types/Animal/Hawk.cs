...
namespace Uzi.Ikosa.Creatures.Types
{
    ...
    public class Hawk : Species
    {
        ...
        public override AbilitySet DefaultAbilities() => new AbilitySet(6, 17, 10, 2, 14, 6);
        ...
        {
            yield return new BodyFeature(this, @"Eyes", true, @"Intently directed eyes");
        ...
        protected override BaseMonsterClass GenerateBaseMonsterClass()
            => new AnimalClass<Hawk>(_Skills, 1, FractionalPowerDie, false);
        ...
        protected override IEnumerable<KeyValuePair<Type, Delta>> GenerateSkillDeltas()
        {
            ...
            yield return new KeyValuePair<Type, Delta>(typeof(SpotSkill), new Delta(8, typeof(Racial)));
            yield break;
        }
        #endregion
