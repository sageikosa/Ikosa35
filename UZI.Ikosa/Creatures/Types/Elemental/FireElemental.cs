...
{
    [Serializable]
    public class FireElemental : Species, IMonitorChange<int>
    {
        #region data
        ...
        {
            var _class = new ElementalClass<FireElemental>(_ClassSkills, 7, false, true, false, _SizeRanges);
        ...
        {
            yield return new LandMovement(50, Creature, this);
            yield break;
        }
        ...
        protected override IEnumerable<TraitBase> GenerateTraits()
        {
            ...
            yield return new ExtraordinaryTrait(this, @"Fire Immunity", @"No damage from fire",
                TraitCategory.Quality, new DeltaTrait(this, new Delta(Int16.MaxValue, typeof(EnergyResistance)),
                Creature.EnergyResistances[EnergyType.Fire]));

            // TODO: cold vulnerability
            // TODO: burn: opponent save or catch fire if opponent's natural weapon or unnarmed attack hits

            // slam (firey slam)
            // TODO: flaming slam + burn (save or catch fire)
        ...
        protected override FeatBase GenerateAdvancementFeat(PowerDie powerDie)
        {
            ...
            {
                case 1: return new DodgeFeat(powerDie, 1);
                case 3: return new MobilityFeat(powerDie, 3);
                case 6: return new SpringAttackFeat(powerDie, 6);
                case 9: return new CombatReflexesFeat(powerDie, 9);
                case 12: return new IronWillFeat(powerDie, 12);
                case 15: return new AlertnessFeat(powerDie, 15);
                case 18: return new BlindFight(powerDie, 18);
                case 21: return new WeaponFocusFeat<Slam>(powerDie, 21);
                case 24: return new GreatFortitudeFeat(powerDie, 24);
            }
            return null;
        }
        ...
        {
            yield return new BodyFeature(this, @"Shape", true, @"Flamey");
        }
        ...
        {
            var _deltas = (armor: 3, str: 0, dex: 3, con: 0);
            switch (args.NewValue)
            {
                case 1:
                case 2: break;
                case 3: _deltas = (3, 0, 5, 2); break;
                case 4:
                case 5: _deltas = (3, 2, 7, 4); break;
                case 6:
                case 7: _deltas = (3, 2, 9, 4); break;
                case 8:
                case 9:
                case 10:
                case 11: _deltas = (4, 4, 11, 6); break;
                case 12:
                case 13:
                case 14:
                case 15: _deltas = (4, 6, 13, 6); break;
                case 16:
                case 17: _deltas = (4, 8, 15, 8); break;
                case 18: _deltas = (5, 8, 15, 8); break;
                case 19: _deltas = (6, 8, 15, 8); break;
                case 20: _deltas = (7, 8, 15, 8); break;
                case 21:
                case 22:
                case 23: _deltas = (8, 10, 17, 8); break;
                default: _deltas = (8, 12, 19, 8); break;
            }
    ...
    [Serializable]
    public class FireElementalLarge : FireElemental
    {
        #region public override Abilities.AbilitySet DefaultAbilities()
        public override AbilitySet DefaultAbilities()
        {
        ...
        protected override BaseMonsterClass GenerateBaseMonsterClass()
        {
            var _class = new ElementalClass<FireElementalLarge>(_ClassSkills, 15, false, true, false, _SizeRanges);
            _class.AddChangeMonitor(this);
            return _class;
        }
    ...
    [Serializable]
    public class FireElementalHuge : FireElemental
    {
        #region public override Abilities.AbilitySet DefaultAbilities()
        public override AbilitySet DefaultAbilities()
        {
        ...
        protected override BaseMonsterClass GenerateBaseMonsterClass()
        {
            var _class = new ElementalClass<FireElementalHuge>(_ClassSkills, 20, false, true, false, _SizeRanges);
            _class.AddChangeMonitor(this);
            return _class;
        }
        ...
        protected override IEnumerable<MovementBase> GenerateMovements()
        {
            yield return new LandMovement(60, Creature, this);
            yield break;
        }
        #endregion
    }
    ...
    [Serializable]
    public class FireElementalGreater : FireElemental
    {
        #region public override Abilities.AbilitySet DefaultAbilities()
        public override AbilitySet DefaultAbilities()
        {
        ...
        protected override BaseMonsterClass GenerateBaseMonsterClass()
        {
            var _class = new ElementalClass<FireElementalGreater>(_ClassSkills, 23, false, true, false, _SizeRanges);
            _class.AddChangeMonitor(this);
            return _class;
        }
    ...
    [Serializable]
    public class FireElementalElder : FireElemental
    {
        #region public override Abilities.AbilitySet DefaultAbilities()
        public override AbilitySet DefaultAbilities()
        {
        ...
        protected override BaseMonsterClass GenerateBaseMonsterClass()
        {
            var _class = new ElementalClass<FireElementalElder>(_ClassSkills, 48, false, true, false, _SizeRanges);
            _class.AddChangeMonitor(this);
            return _class;
        }
