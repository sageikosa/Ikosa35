...
{
    [Serializable]
    public class Goblin : BaseHumanoidSpecies
    {
        public Goblin()
            : base()
        {
        ...
        protected override IEnumerable<KeyValuePair<Type, Delta>> GenerateSkillDeltas()
        {
            ...
            yield return new KeyValuePair<Type, Delta>(typeof(RideSkill), _skill);
            yield break;
        }
        #endregion
        ...
        {
            yield return new ExtraordinaryTrait(this, @"Goblin Strength", @"-2", TraitCategory.Quality,
                new DeltaTrait(this, new Delta(-2, this, @"Racial Trait"), Creature.Abilities.Strength));
            yield return new ExtraordinaryTrait(this, @"Goblin Dexterity", @"+2", TraitCategory.Quality,
                new DeltaTrait(this, new Delta(2, this, @"Racial Trait"), Creature.Abilities.Dexterity));
            yield return new ExtraordinaryTrait(this, @"Goblin Charisma", @"-2", TraitCategory.Quality,
