...
{
    [Serializable]
    public class Craftsman : NonPlayerService
    {
        /// <summary>Relationship type to identify a part (http://pack.guildsmanship.com/ikosa/)</summary>
        public const string Relation = @"http://pack.guildsmanship.com/ikosa/craftsman";

        // TODO: items repairable/producible
        // TODO: sub-classes: alchemy, armor, bow, weaponsmithing

        public Craftsman(Description description)
            : base(description)
        {
        }

        protected override string NodeExtension => @"craftsman";
        protected override string ContentType => @"ikosa/craftsman";
        protected override string RelationshipType => Relation;

        public override string TypeName => typeof(Craftsman).FullName;
