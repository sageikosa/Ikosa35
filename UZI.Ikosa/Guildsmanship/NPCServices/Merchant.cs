...
{
    [Serializable]
    public class Merchant : NonPlayerService
    {
        /// <summary>Relationship type to identify a part (http://pack.guildsmanship.com/ikosa/)</summary>
        public const string Relation = @"http://pack.guildsmanship.com/ikosa/merchant";

        // TODO: available inventory (general or specific)
        // TODO: categories/specialities

        public Merchant(Description description)
            : base(description)
        {
        }

        protected override string NodeExtension => @"merchant";
        protected override string ContentType => @"ikosa/merchant";
        protected override string RelationshipType => Relation;

        public override string TypeName => typeof(Merchant).FullName;
