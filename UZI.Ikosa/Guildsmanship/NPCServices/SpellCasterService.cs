...
{
    [Serializable]
    public class SpellCasterService : NonPlayerService
    {
        /// <summary>Relationship type to identify a part (http://pack.guildsmanship.com/ikosa/)</summary>
        public const string Relation = @"http://pack.guildsmanship.com/ikosa/spellcasting";

        // TODO: caster type and level, spell-list

        public SpellCasterService(Description description)
            : base(description)
        {
        }

        protected override string NodeExtension => @"spellcasting";
        protected override string ContentType => @"ikosa/spellcasting";
        protected override string RelationshipType => Relation;

        public override string TypeName => typeof(SpellCasterService).FullName;
