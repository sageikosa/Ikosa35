...
{
    [Serializable]
    public class DazeMonster : SpellDef, ISpellMode, IDurableCapable, IActionSkip, ISaveCapable
    {
        public override string DisplayName => @"Daze";
        public override string Description => @"No actions for one round for creature with 6 PD or less";
        ...
        {
            yield return new AwarenessAim(@"Creature", @"Creature", new FixedRange(1), new FixedRange(1), new MediumRange(), new CreatureTargetType());
            yield break;
        }
        ...
        public void ActivateSpell(PowerActivationStep<SpellSource> deliver)
        {
            ...
            if (_critter.AdvancementLog.NumberPowerDice <= 6)
            {
