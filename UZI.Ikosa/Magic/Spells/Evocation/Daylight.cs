...
{
    [Serializable]
    public class Daylight : SpellDef, ISpellMode, IDurableCapable, ICounterDispelCapable
    {
        public Daylight()
            : base()
        {
        ...
        public override string DisplayName => @"Daylight";
        public override string Description => @"Object illuminates a 60 foot radius sphere with very bright light";
        public override MagicStyle MagicStyle => new Evocation();
        public override bool Equals(object obj) => obj.GetType().Equals(typeof(Daylight));
        ...
        {
            var _illumination = new MagicLight(source, 60, 120, true);
        ...
        public IEnumerable<Type> DescriptorTypes
        {
            get
            {
                yield return typeof(Actions.Darkness);
                yield break;
            }
        }
        #endregion
