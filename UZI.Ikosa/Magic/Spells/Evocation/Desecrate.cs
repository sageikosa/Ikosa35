...
{
    [Serializable]
    public class Desecrate : SpellDef, ISpellMode, IDurableCapable, IRegionCapable, IGeometryCapable<SpellSource>
    {
        public override string DisplayName => @"Desecrate";
        public override string Description => @"Curse area with negative energy.  Decreased driving undead power.  Undead bonuses.";
        public override MagicStyle MagicStyle => new Evocation();
        public override IEnumerable<Descriptor> Descriptors => new Evil().ToEnumerable();
