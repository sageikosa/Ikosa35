...
{
    [Serializable]
    public class ReducePerson : SpellDef, ISpellMode, IDurableCapable, ISaveCapable, ICounterDispelCapable
    {
        public override string DisplayName { get { return @"Reduce Person"; } }
        public override string Description { get { return @"Humanoid size decreases"; } }
        public override MagicStyle MagicStyle { get { return new Transformation(); } }
        ...
        {
            var _enlarge = new ReduceEffect(source);
        ...
        public IEnumerable<Type> CounterableSpells
        {
            get
            {
                yield return typeof(EnlargePerson);
                yield break;
            }
        }
    ...
    [Serializable]
    public class ReduceEffect : Adjunct, IMonitorChange<ICoreObject>
    {
        #region Construction
        public ReduceEffect(object source)
            : base(source)
        {
        ...
        {
            var _critter = Anchor as Creature;
            var _loc = Locator.FindFirstLocator(_critter) as ObjectPresenter;
            ...
            // reach
            if (_critter.Body.Sizer.Size.Order < -1)
            {
        ...
        {
            return new ReduceEffect(Source);
        }
    }
}
