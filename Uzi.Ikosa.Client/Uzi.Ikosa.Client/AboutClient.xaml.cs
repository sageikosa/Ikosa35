...
{
    /// <summary>
    /// Interaction logic for AboutClient.xaml
    /// </summary>
    public partial class AboutClient : Window
    {
        /// <summary>
        /// Default constructor is protected so callers must use one with a parent.
        /// </summary>
        protected AboutClient()
        {
            InitializeComponent();
        }

        /// <summary>
        /// Constructor that takes a parent for this AboutClient dialog.
        /// </summary>
        /// <param name="parent">Parent window for this dialog.</param>
        public AboutClient(Window parent)
            : this()
        {
            this.Owner = parent;
        }
