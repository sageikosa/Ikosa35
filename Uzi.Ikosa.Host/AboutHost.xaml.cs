...
{
    /// <summary>
    /// Interaction logic for AboutHost.xaml
    /// </summary>
    public partial class AboutHost : Window
    {
        /// <summary>
        ...
        /// <summary>
        /// Constructor that takes a parent for this AboutHost dialog.
        /// </summary>
        /// <param name="parent">Parent window for this dialog.</param>
        public AboutHost(Window parent)
            : this()
        {
            this.Owner = parent;
        }
