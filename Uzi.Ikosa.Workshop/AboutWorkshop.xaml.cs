...
{
    /// <summary>
    /// Interaction logic for AboutWorkshop.xaml
    /// </summary>
    public partial class AboutWorkshop : Window
    {
        /// <summary>
        /// Default constructor is protected so callers must use one with a parent.
        /// </summary>
        protected AboutWorkshop()
        {
            InitializeComponent();
        }

        /// <summary>
        /// Constructor that takes a parent for this AboutWorkshop dialog.
        /// </summary>
        /// <param name="parent">Parent window for this dialog.</param>
        public AboutWorkshop(Window parent)
            : this()
        {
            this.Owner = parent;
        }
